            ...
            {filtered.map((participant, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className={'font-display text-xl sm:text-3xl tracking-wider w-8 sm:w-12 shrink-0 ' + medalColor}>
                      {rankLabel}
                    </div>
                      ...
                      {participantPicks.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2">
                          {participantPicks.map(pickItem => {
                            ...
                            const borderClass = alive ? 'bg-emerald-500/10 border-emerald-500/20' : 'bg-white/5 border-white/10'
                            return (
                              <div key={team.id} className={'flex items-center justify-between px-3 py-2 rounded-lg text-sm border ' + borderClass}>
                                ...
                                <div className="text-right shrink-0 ml-2">
                                  {alive ? <div className="text-emerald-400 text-xs">● alive</div> : null}
